d3.politicos = function (containerId, width, partidoDetalle) {
    ...
    function _createHover() {
        ...
        partidosHover
            .transition()
            .attr("y", function (d) {
                return y(d) - partido_guia_height / 2;
            });
    ...
    function _createGuias() {
        ...
        partidoGruposData = d3.nest()
            .key(function (d) {
                return (d.grupo) ? d.grupo : 'p' + d.id_partido;
            })
        ...
        partidos_items
            .transition()
            .attr("y", function (d) {
                return y(d.values[0].id_partido) - partido_guia_height / 2;
            })
    ...
    function _createLines() {
        ...
        lines
            .attr("d", function (d) {
                return line(chart.selectAll('.participacion-' + d[0].id)[0]);
            })
            .attr("class", function (d) {
                return "line line-" + d[0].id + ' line-' + d[0].color;
            })
    ...
    return {
        update: function (newData, extraData) {
            ...
            circlesData = d3.nest()
                ...
                .key(function (d) {
                    return d.id_candidato;
                })
                .sortValues(function (a, b) {
                    return parseFloat(a.id_candidato) - parseFloat(b.id_candidato);
                })
                .map(newData, d3.map);
